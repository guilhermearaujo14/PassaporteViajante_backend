...
export class ViajanteController{
    ...
    public static async Create(req: Request, res: Response){
        const { nome, email, senha, isAtivo, isPerfilPrivado, cidadeReferencia, telefone } = req.body;
        try {
            const response = await ViajanteService.Create(nome, email, senha, isAtivo, isPerfilPrivado, cidadeReferencia, telefone);
